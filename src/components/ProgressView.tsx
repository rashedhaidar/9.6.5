            ...
            {LIFE_DOMAINS.map(domain => {
              ...
              switch (domain.id) {
                ...
                case 'social':
                  ...
                  break;
                case 'financial':
                  domainColor = 'linear-gradient(to right, #008000, #90EE90)'; // Green to Light Green
                  break;
                case 'personal':
                ...
                >
                  ...
                  <div className="relative w-full h-4 bg-black/30 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${percentage}%`, background: domainColor, transform: `scaleX(${percentage / 100})`, borderRadius: '10px', opacity: 0.4, transformOrigin: 'left' }}
                    />
                    <span 
